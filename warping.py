...
# python warping.py --occlusion --test_name warping1 --tocg_checkpoint checkpoints/condition_generator_test/tocg_final.pth --gpu_ids 0 --datasetting paired --dataroot data --data_list test_pairs.txt
# python warping.py --occlusion --tocg_checkpoint checkpoints/condition_generator_test/tocg_final.pth --D_checkpoint checkpoints/condition_generator_test/D_final.pth --gpu_ids 0  --datasetting paired --dataroot data --data_list test_pairs.txt
...
def get_opt():
    ...
    parser.add_argument("--output_dir", type=str, default="./warps_train")
    ...
    parser.add_argument('--tocg_checkpoint', type=str, default='checkpoints/condition_256/condition_first_depth_cloth_front_256_multiheadatt_8/tocg_step_101780.pth',
...
def test(opt, test_loader, tocg, generator):
    ...
    with torch.no_grad():
        for inputs in test_loader.data_loader:
            ...
            # save output
            save_images(warped_cloth, unpaired_names, output_dir)
