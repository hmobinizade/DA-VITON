...
def get_opt():
    ...
    parser.add_argument('--tocg_checkpoint', type=str, default='checkpoints/condition_256/condition_first_depth_256_multiheadatt_8_newwatt_8/tocg_step_072700.pth', help='tocg checkpoint')
    parser.add_argument('--D_checkpoint', type=str, default='checkpoints/condition_256/condition_first_depth_256_multiheadatt_8_newwatt_8/D_step_072700.pth', help='D checkpoint')
...
def test(opt, test_loader, board, tocg, D=None):
    ...
    for inputs in test_loader.data_loader:
        ...
        # input1
        c_paired = inputs['cloth_front'][opt.datasetting].cuda()
        cm_paired = inputs['cloth_front_mask'][opt.datasetting].cuda()
        ...
        with torch.no_grad():
            ...
            input2 = torch.cat([depth, parse_agnostic, densepose], 1)
