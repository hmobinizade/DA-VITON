...
def get_opt():
    ...
    parser.add_argument('--predict_dir', default='condition_first_depth_cloth_front_multiheadatt_8_150p_1024')
    parser.add_argument('--ground_truth_dir', default='C:/hd-vton-dataset/test/image')
            ...
            try:
                ...
                if not opt.resolution == 1024:
                    if opt.resolution == 512:
                        ...
                        pred_img = pred_img.resize((384,512), Image.BILINEAR)
                ...
                avg_distance += round(lpips_list[-1][1], 4)
                ...
                print(f"step: {i+1} evaluation... lpips:{lpips_list[-1][1]} , {round(lpips_list[-1][1], 4)}")
            except :
                continue
